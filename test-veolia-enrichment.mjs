...
try {
  ...
  console.log(
    `  - categoria: ${primeiroMercado.mercado.categoria ? "✅" : "❌"}`
  );
  console.log(
    `  - segmentacao: ${primeiroMercado.mercado.segmentacao ? "✅" : "❌"}`
  );
  console.log(
    `  - tamanhoEstimado: ${primeiroMercado.mercado.tamanhoEstimado ? "✅" : "❌"}`
  );
  ...
  if (primeiroMercado.concorrentes.length > 0) {
    ...
    console.log(
      `  - descricao: ${primeiroConcorrente.descricao ? "✅" : "❌"}`
    );
  ...
  if (primeiroMercado.leads.length > 0) {
    ...
    console.log(
      `  - justificativa: ${primeiroLead.justificativa ? "✅" : "❌"}`
    );
  }
  ...
  console.log(
    "   A API OpenAI está retornando dados completos e estruturados."
  );
  console.log(
    "   Se o banco está vazio, o problema está na GRAVAÇÃO, não na API.\n"
  );
