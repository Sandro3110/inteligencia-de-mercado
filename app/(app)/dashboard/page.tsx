        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">Dashboard de Inteligência de Mercado</p>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button className="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-500">Criar projeto de pesquisa</p>
              </div>
            </button>
            ...
            <button className="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-500">Acessar relatórios gerados</p>
              </div>
            </button>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Sistema Operacional</h3>
              <div className="mt-2 text-sm text-blue-700">
                <p>O sistema está funcionando corretamente. Autenticação via Supabase ativa.</p>
              </div>
            </div>
          </div>
        </div>
