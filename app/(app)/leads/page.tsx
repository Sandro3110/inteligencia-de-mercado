...
const TagManager = dynamic(() => import('@/components/TagManager'), { ssr: false });
const TagFilter = dynamic(() => import('@/components/TagFilter'), { ssr: false });
const SavedFilters = dynamic(() => import('@/components/SavedFilters'), { ssr: false });
      ...
      <div className="mb-6 border-b border-gray-200">
        <nav className="flex gap-8">
          {[
            ...
            { id: 'filters', label: 'Filtros Avançados', icon: Filter },
          ].map((tab) => {
            const Icon = tab.icon;
            return (
              <button
