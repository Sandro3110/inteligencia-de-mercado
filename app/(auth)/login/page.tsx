  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div>
        ...
        <p className="mt-2 text-center text-sm text-gray-600">Faça login para acessar sua conta</p>
      </div>
        ...
        <div className="space-y-4 rounded-md shadow-sm">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute inset-y-0 right-0 z-10 flex items-center pr-3 text-gray-400 hover:text-gray-600 cursor-pointer"
