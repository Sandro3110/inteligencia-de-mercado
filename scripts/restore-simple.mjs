    ...
    for (const m of mercados) {
      ...
      await connection.execute(
        ...
        [
          ...
          mercado.potencialCrescimento,
          mercado.nivelConcorrencia,
    ...
    for (const c of concorrentes) {
      ...
      await connection.execute(
        ...
        [
          ...
          concorrente.produto,
          concorrente.porte,
          concorrente.faturamentoEstimado,
          concorrente.qualidadeScore,
          concorrente.qualidadeClassificacao,
          concorrente.validationStatus || "pending",
          concorrente.validationNotes,
          concorrente.validatedBy,
          concorrente.validatedAt,
          concorrente.createdAt || new Date(),
        ]
      );
      count++;
      if (count % 50 === 0)
