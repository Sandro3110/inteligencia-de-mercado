...
async function deleteEmptyRecords() {
  ...
  if (emptyPesquisas.length > 0) {
    ...
    for (const p of emptyPesquisas) {
      ...
      console.log(
        `    Clientes: ${p.clientesCount}, Mercados: ${p.mercadosCount}, Concorrentes: ${p.concorrentesCount}, Leads: ${p.leadsCount}, Produtos: ${p.produtosCount}`
      );
    }
  ...
  if (emptyProjects.length > 0) {
    ...
    for (const p of emptyProjects) {
      ...
      console.log(
        `    Pesquisas: ${p.pesquisasCount}, Clientes: ${p.clientesCount}, Mercados: ${p.mercadosCount}, Concorrentes: ${p.concorrentesCount}, Leads: ${p.leadsCount}, Produtos: ${p.produtosCount}`
      );
    }
  ...
  console.log(
    `📊 Resumo: ${emptyPesquisas.length} pesquisas e ${emptyProjects.length} projetos deletados`
  );
}
