...
const navSections: NavSection[] = [
  ...
  // ========================================
  {
    ...
    items: [
      ...
      {
        title: "Atividade de Projetos",
        href: "/projetos/atividade",
        icon: FolderOpen,
        badge: "Novo",
      },
          ...
          <div className="space-y-3 max-w-full overflow-hidden">
            ...
            {selectedProjectId ? (
              <div className="space-y-1.5">
                ...
                <PesquisaSelector
                  key={`pesquisa-${selectedProjectId}`}
