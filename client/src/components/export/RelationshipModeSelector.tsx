...
export function RelationshipModeSelector({
  value,
  onChange,
}: RelationshipModeSelectorProps) {
  const modes: Mode[] = [
    {
      id: "direct",
      title: "Direto",
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                <div
                  className={`p-2 rounded-lg ${isSelected ? "bg-white" : "bg-slate-50"}`}
                >
      ...
      {value === "full" && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
          <p className="text-xs text-yellow-800">
            ⚠️ <strong>Atenção:</strong> Modo completo pode gerar arquivos
            grandes e demorar mais tempo para processar. Considere adicionar
