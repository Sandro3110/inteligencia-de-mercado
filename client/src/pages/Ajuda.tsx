...
export default function Ajuda() {
  ...
  const tutorials = [
    ...
    },
    {
      ...
      duration: "8 min",
      thumbnail: "https://via.placeholder.com/320x180/10b981/ffffff?text=Projeto",
      url: "#",
      badge: "Iniciante",
    },
    {
      ...
      duration: "12 min",
      thumbnail: "https://via.placeholder.com/320x180/f59e0b/ffffff?text=Enriquecimento",
      url: "#",
      badge: "Intermediário",
    },
    {
    ...
    },
    {
      ...
      duration: "7 min",
      thumbnail: "https://via.placeholder.com/320x180/ec4899/ffffff?text=Geo",
      url: "#",
      badge: "Avançado",
    },
    {
      ...
      duration: "9 min",
      thumbnail: "https://via.placeholder.com/320x180/06b6d4/ffffff?text=Alertas",
      url: "#",
      badge: "Avançado",
    },
  ];
