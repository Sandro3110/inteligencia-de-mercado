...
export default function AnalyticsDashboard() {
  ...
  const { data: qualityEvolution } = trpc.analytics.qualityEvolution.useQuery(
    { projectId: selectedProjectId!, days: period },
    { enabled: !!selectedProjectId }
  );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Visualize métricas e insights dos seus projetos
          </p>
        </div>
      ...
      {!selectedProjectId ? (
        <Card>
          <CardContent className="flex items-center justify-center h-64">
            <p className="text-muted-foreground">Selecione um projeto para visualizar as métricas</p>
          </CardContent>
        </Card>
      ) : (
        <>
