        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 mt-1">
              Acompanhe conversões e retorno sobre investimento
            </p>
          </div>
          <Button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="bg-white border-slate-200 shadow-sm">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-slate-900">
                R${" "}
                {metrics.averageDealValue.toLocaleString("pt-BR", {
                ...
                <tbody>
                  {conversions?.map((conv: any) => (
                    <tr key={conv.id} className="border-b border-slate-800/50">
                      ...
                      <td className="py-3 px-4 text-slate-900">
                        {conv.dealValue
                          ? `R$ ${parseFloat(conv.dealValue).toLocaleString("pt-BR", { minimumFractionDigits: 2 })}`
                          : "-"}
                      </td>
      ...
      >
        <DialogContent className="bg-white border-slate-200">
          ...
          <div className="space-y-4">
            <div>
              <Label htmlFor="lead" className="text-slate-700">
                Lead
              </Label>
              <select
                id="lead"
            ...
            <div>
              <Label htmlFor="dealValue" className="text-slate-700">
                Valor do Deal (R$)
              </Label>
              <Input
                id="dealValue"
