...
export default function NotificationHistory() {
  ...
  const filteredNotifications =
    notifications?.filter((notif: any) => {
      ...
      if (statusFilter === "read" && notif.isRead === 0) {
        return false;
      }
      if (statusFilter === "unread" && notif.isRead === 1) {
        return false;
      }
  ...
  const stats = {
    ...
    readRate:
      filteredNotifications.length > 0
        ? Math.round(
            (filteredNotifications.filter((n: any) => n.isRead === 1).length /
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge
                          variant={notif.isRead === 1 ? "secondary" : "default"}
                        >
                          {NOTIFICATION_TYPE_LABELS[notif.type] || notif.type}
                        </Badge>
                        {notif.isRead === 1 && (
