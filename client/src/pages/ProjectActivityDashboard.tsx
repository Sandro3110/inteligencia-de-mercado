          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button 
                ...
                disabled={inactiveCount === 0 || autoHibernateMutation.isPending}
                variant="destructive"
                size="sm"
              >
          ...
          {inactiveProjects.length === 0 ? (
            ...
            <div className="space-y-4">
              {inactiveProjects.map((project) => (
                <Card key={project.id} className="border-orange-200 bg-orange-50/50">
                      ...
                      <div className="flex-1">
                        ...
                        <CardDescription className="flex items-center gap-2 mt-1">
                          ...
                          {project.daysSinceActivity !== null ? (
                            ...
                            <span className="text-muted-foreground">Sem registro de atividade</span>
                          )}
                        </CardDescription>
                      </div>
                    </div>
                        ...
                        {project.recentActions.map((action, idx) => (
                          <div key={idx} className="flex items-center gap-2 text-sm">
                            ...
                            {action.userName && (
                              <>
                                <span className="text-muted-foreground">•</span>
                                <span className="text-muted-foreground">{action.userName}</span>
                              </>
                            )}
                          </div>
                        ))}
                  ...
                  <div className="flex items-center gap-4 mt-1 text-sm text-muted-foreground">
                    ...
                    {project.recentActions.length > 0 && (
                      <span className="flex items-center gap-1">
                        ...
                        Última ação: {getActionLabel(project.recentActions[0].action)}
                      </span>
                    )}
                  </div>
                </div>
