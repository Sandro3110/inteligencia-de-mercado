            ...
            <div className="p-4 border-2 border-green-300 rounded-lg bg-green-50">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-semibold text-green-800">
                  {data.mercados.length} mercado
                  {data.mercados.length > 1 ? "s" : ""} adicionado
                  {data.mercados.length > 1 ? "s" : ""} - Pronto para continuar!
                </p>
              </div>
            </div>
          )}
      ...
      <div className="space-y-4">
        ...
        <Button
          onClick={() => {
            ...
            toast.success(
              `${validMercados.length} mercado(s) validado(s) com sucesso!`
            );
          }}
        ...
        >
          {isDataValidated
            ? "✓ Dados Já Validados - Clicar para Revalidar"
