...
/**
 * NÍVEL 1: Visualização de categorias de produtos
 * Mostra lista de categorias com contadores agregados
 */
export function ProductCategoriesView({ pesquisaIds, onDrillDown }: ProductCategoriesViewProps) {
  const { data, isLoading } = trpc.productDrillDown.getCategories.useQuery({
    pesquisaIds,
  });
      ...
      <Card>
        <CardContent className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Nenhuma categoria de produto encontrada</p>
          </div>
        </CardContent>
      </Card>
    );
