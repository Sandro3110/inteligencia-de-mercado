...
/**
 * Step 2: Filters - Refinamento de filtros para exportação
 * Componente interativo com gerenciamento de estado complexo
 */
...
const STATUS_OPTIONS = ['validado', 'pendente', 'descartado'];
...
export default function Step2Filters({ state, setState }: Step2FiltersProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold text-slate-900 mb-2">Refine os Filtros</h2>
      ...
      <div className="space-y-3">
        ...
        <div>
          <Label htmlFor="states" className="text-sm text-slate-600">
            Estados
          </Label>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <Label htmlFor="completeness" className="text-sm text-slate-600">
              Completude Mínima (%)
            </Label>
            <Input
              id="completeness"
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="revenueMin" className="text-sm text-slate-600">
              Mínimo
            </Label>
            <Input
              id="revenueMin"
          ...
          <div>
            <Label htmlFor="revenueMax" className="text-sm text-slate-600">
              Máximo
            </Label>
            <Input
              id="revenueMax"
