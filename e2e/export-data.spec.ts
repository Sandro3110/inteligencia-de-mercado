...
test.describe("Exportação de Dados", () => {
  ...
  test("deve exibir botão de exportação", async ({ page }) => {
    ...
    const exportButton = await page
      .locator('button:has-text("Exportar"), button:has-text("Export")')
      .first()
      .isVisible()
      .catch(() => false);
  ...
  test("deve exibir relatórios", async ({ page }) => {
    ...
    const hasTitle = await page
      .locator("text=/Relatórios|Reports/i")
      .isVisible();
    expect(hasTitle).toBeTruthy();

    // Verificar botão gerar relatório
    const hasGenerateButton = await page
      .locator('button:has-text("Gerar"), button:has-text("Generate")')
      .isVisible()
      .catch(() => false);
  ...
  test("deve exibir seletor de projetos", async ({ page }) => {
    ...
    const hasProjectSelector = await page
      .locator("text=/Projeto|Project|Selecione/i")
      .isVisible();
  ...
  test("deve exibir estatísticas na página inicial", async ({ page }) => {
    ...
    const hasStats = await page
      .locator("text=/Total|Mercados|Clientes|Leads/i")
      .isVisible();
