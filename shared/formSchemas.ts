...
export const intelligentAlertsSchema = z.object({
  ...
  notifySlack: z.string().url("URL do Slack inválida").optional(),
...
export const errorMessages = {
  adminLLM: {
    provider:
      "Por favor, selecione um provedor de LLM (OpenAI, Gemini ou Anthropic)",
    apiKey:
      "A API Key deve ter entre 10 e 500 caracteres e conter apenas letras, números, hífens e underscores",
  ...
  intelligentAlerts: {
    ...
    cooldownMinutes:
      "O cooldown deve estar entre 1 minuto e 24 horas (1440 minutos)",
