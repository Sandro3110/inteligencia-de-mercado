...
async function main() {
  ...
  console.log('\n╔════════════════════════════════════════════════════════════════╗');
  console.log('║              LIMPEZA DE REGISTROS ÓRFÃOS                       ║');
  console.log('╚════════════════════════════════════════════════════════════════╝\n');
  ...
  try {
    ...
    if (totalOrphans === 0) {
      console.log('✅ Nenhum registro órfão encontrado. Banco já está limpo!\n');
    ...
    console.log(`   ✅ ${concResult.affectedRows} concorrentes órfãos removidos\n`);
    ...
    const fs = require('fs');
    fs.writeFileSync('/home/ubuntu/CLEANUP_RESULTS.json', JSON.stringify(cleanupResult, null, 2));
