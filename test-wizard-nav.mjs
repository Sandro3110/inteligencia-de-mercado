...
(async () => {
  ...
  // Capturar screenshot
  await page.screenshot({ path: '/home/ubuntu/screenshots/wizard-step1.png', fullPage: true });
  ...
  const noProjectMsg = await page.locator('text=Nenhum projeto encontrado').count();
