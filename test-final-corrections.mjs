...
async function test() {
  ...
  console.log(
    "║         TESTE FINAL DAS 3 CORREÇÕES DE BUGS                   ║"
  );
  console.log(
    "╚════════════════════════════════════════════════════════════════╝\n"
  );
  ...
  try {
    ...
    console.log(
      `📊 Taxa: ${((clientes.length / duration) * 60).toFixed(1)} clientes/min\n`
    );
    ...
    console.log(
      "║         VERIFICAÇÃO DAS 3 CORREÇÕES NOS DADOS NOVOS           ║"
    );
    console.log(
      "╚════════════════════════════════════════════════════════════════╝\n"
    );
    ...
    qualityCheck.forEach(row => {
      ...
      console.log(
        `     - Com classificação: ${row.comClassificacao}/${row.total} (${((row.comClassificacao / row.total) * 100).toFixed(1)}%)\n`
      );
    });
    ...
    const classificacaoOK =
      qualityCheck[0].comClassificacao === qualityCheck[0].total; // 100%
