...
**Média Prioridade:**
4. Recalibrar fórmula de qualidadeScore (penalizar dados não validados)
5. Adicionar flag "validado_manualmente" para dados confiáveis
6. Implementar sistema de confiança (0-100%) por campo

**Baixa Prioridade:**
7. Revisar duplicatas conceituais manualmente
8. Implementar deduplicação inteligente por CNPJ
9. Adicionar fonte de dados (ReceitaWS vs Gemini vs Manual)
