...
describe('Fase 54: Melhorias Avançadas', () => {
  ...
  describe('54.2: Filtros Avançados no Modal de Comparação', () => {
    it('deve ter componente CompararMercadosModal com filtros', async () => {
      ...
      const modalPath = path.resolve(__dirname, '../../client/src/components/CompararMercadosModal.tsx');
  ...
  describe('54.3: Dashboard de Tendências', () => {
    it('deve ter página TendenciasDashboard', async () => {
      ...
      const dashboardPath = path.resolve(__dirname, '../../client/src/pages/TendenciasDashboard.tsx');
    ...
    it('deve ter link de Tendências no sidebar', async () => {
      ...
      const sidebarPath = path.resolve(__dirname, '../../client/src/components/AppSidebar.tsx');
