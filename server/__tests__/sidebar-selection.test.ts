...
describe("Sidebar Project and Pesquisa Selection", () => {
  ...
  it("should list pesquisas filtered by project", async () => {
    const pesquisasProject1 = await caller.pesquisas.list({ projectId: projectId1 });
    const pesquisasProject2 = await caller.pesquisas.list({ projectId: projectId2 });
  ...
  it("should get dashboard stats for specific project", async () => {
    const statsProject1 = await caller.dashboard.stats({ projectId: projectId1 });
    const statsProject2 = await caller.dashboard.stats({ projectId: projectId2 });
  ...
  it("should return empty pesquisas when project has none", async () => {
    ...
    const pesquisas = await caller.pesquisas.list({ projectId: emptyProject.id });
