...
export class PDFReportRenderer {
  ...
  private renderCover(
    ...
    doc
      .fontSize(10)
      .text(
        "Gestor PAV - Inteligência de Mercado",
        this.MARGIN,
  ...
  private renderMetrics(
    ...
    metricsToShow.forEach(([key, value], index) => {
      ...
      doc
        ...
        .font("Helvetica")
        .fillColor("#64748b")
        .text(this.formatMetricLabel(key), x + 10, y + 10, {
          width: colWidth - 30,
        });
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fillColor("#1e40af")
        .text(this.formatMetricValue(value), x + 10, y + 30, {
          width: colWidth - 30,
        });
  ...
  private renderInsights(doc: PDFKit.PDFDocument, insights: Insight[]): void {
    ...
    insights.forEach((insight, index) => {
      ...
      doc
        ...
        .fillColor("#64748b")
        .text(
          `${this.formatCategory(insight.category)} | Impacto: ${insight.impact.toUpperCase()}`,
          this.MARGIN + 25
        );
  ...
  private renderSWOT(doc: PDFKit.PDFDocument, swot: unknown): void {
    ...
    quadrants.forEach(quadrant => {
      // Box
      doc
        .rect(quadrant.x, quadrant.y, boxWidth, boxHeight)
        .fillAndStroke("#ffffff", quadrant.color);
