 ...
 */
async function trackMercadoChanges(
  mercadoId,
  changes,
  changeType = "updated",
  changedBy = "system"
 ...
 */
async function trackClienteChanges(
  clienteId,
  changes,
  changeType = "updated",
  changedBy = "system"
 ...
 */
async function trackConcorrenteChanges(
  concorrenteId,
  changes,
  changeType = "updated",
  changedBy = "system"
 ...
 */
async function trackLeadChanges(
  leadId,
  changes,
  changeType = "updated",
  changedBy = "system"
...
async function trackCreation(
  ...
  switch (entityType) {
    case "mercado":
      await db
        .insert(schema_1.mercadosHistory)
        .values({ ...change, mercadoId: entityId });
      break;
    case "cliente":
      await db
        .insert(schema_1.clientesHistory)
        .values({ ...change, clienteId: entityId });
      break;
    case "concorrente":
      await db
        .insert(schema_1.concorrentesHistory)
        .values({ ...change, concorrenteId: entityId });
      break;
    case "lead":
      await db
        .insert(schema_1.leadsHistory)
        .values({ ...change, leadId: entityId });
      break;
  }
