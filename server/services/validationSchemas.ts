...
export function validateMercadoBatch(
  data: unknown
): ValidationResult<z.infer<typeof MercadoBatchSchema>> {
  try {
...
export function validateClienteBatch(
  data: unknown
): ValidationResult<z.infer<typeof ClienteBatchSchema>> {
  try {
...
export function validatePesquisaConfig(
  data: unknown
): ValidationResult<PesquisaConfig> {
  try {
