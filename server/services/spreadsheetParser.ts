...
function parseRow(row: any[], columnMap: Record<string, string>): any {
  const parsed: any = {};
...
export function generateTemplate(type: 'mercado' | 'cliente'): Buffer {
  const headers = type === 'mercado'
    ? ['Nome', 'Descrição', 'Segmentação', 'Categoria', 'Tamanho Estimado', 'Tendência']
    : ['Nome', 'Razão Social', 'CNPJ', 'Site', 'Email', 'Telefone', 'Endereço', 'Cidade', 'Estado', 'CEP', 'Porte', 'Setor', 'Descrição'];
  
  const exampleRow = type === 'mercado'
    ? ['Embalagens Plásticas para Indústria Alimentícia', 'Indústrias que precisam de embalagens', 'B2B', 'Embalagens', 'R$ 2B/ano', 'Crescimento 5% a.a.']
    : ['Empresa Exemplo Ltda', 'Empresa Exemplo Indústria e Comércio Ltda', '12345678000190', 'https://exemplo.com.br', 'contato@exemplo.com.br', '11987654321', 'Rua Exemplo, 123', 'São Paulo', 'SP', '01234567', 'Médio', 'Indústria', 'Empresa de exemplo'];
