 ...
 */
export async function validateCNPJsBatch(cnpjs: string[], delayMs: number = 350): Promise<Map<string, ReceitaWSResponse>> {
  ...
  console.log(`[ReceitaWS] Validated ${results.size}/${cnpjs.length} CNPJs successfully`);
