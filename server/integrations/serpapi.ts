 ...
 */
export async function searchCompetitors(params: SerpAPISearchParams): Promise<CompetitorData[]> {
 ...
 */
export async function searchCompanyInfo(companyName: string): Promise<CompetitorData | null> {
  try {
